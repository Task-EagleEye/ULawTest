...
namespace ULaw.ApplicationProcessor.Tests
{
  ...
  public class ApplicationSubmissionTests
  {
    ...
    private readonly ApplicationData thisApplicationData = new ApplicationData()
    {
      CourseCode = "ABC123",
      DateOfBirth = new DateTime(2019, 9, 22),
      Faculty = "Law",
      FirstName = "Test",
      LastName = "Tester",
      RequiresVisa = false,
      StartDate = new DateTime(1991, 08, 14),
      Title = "Mr"
    };
    ...
    {
      Application thisSubmission = new Application(this.thisApplicationData);
